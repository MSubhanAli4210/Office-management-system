  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative group mb-8">
          <div className="absolute -inset-0.5 bg-linear-to-r from-blue-600 to-cyan-600 rounded-2xl blur opacity-75 transition duration-500"></div>
          <div className="relative bg-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div className="bg-linear-to-br from-purple-700 to-blue-700 p-6 rounded-lg">
            <p className="text-gray-300 text-sm">Total Sales</p>
            <p className="text-3xl font-bold text-cyan-400">
              ${totalSales.toLocaleString()}
            </p>
          </div>
          <div className="bg-linear-to-br from-blue-700 to-cyan-700 p-6 rounded-lg">
            <p className="text-gray-300 text-sm">Total Transactions</p>
            <p className="text-3xl font-bold text-cyan-400">{sales.length}</p>
          </div>
        </div>
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-linear-to-r from-purple-600 to-blue-600 rounded-2xl blur opacity-75 transition duration-500"></div>
          <div className="relative bg-slate-800 rounded-2xl p-8 shadow-2xl overflow-x-auto">
            ...
            {sales.length === 0 ? (
              <p className="text-center text-gray-400 py-8">
                No sales yet. Add one to get started!
              </p>
            ) : (
