    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="relative group">
          <div className="absolute -inset-0.5bg-linear-to-r from-purple-600 to-blue-600 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-500"></div>
          <div className="relative bg-slate-800 rounded-2xl p-8 md:p-12 shadow-2xl transform group-hover:scale-105 transition duration-300">
            <h1 className="text-5xl md:text-6xl font-bold mb-6bg-linear-to-r from-cyan-400 via-blue-400 to-purple-500 bg-clip-tex text-purple-300 animate-puls">
            ...
            <button className="mt-8 px-8 py-3 bg-linear-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transform hover:scale-110 transition duration-300 animate-bounce">
              Start Investing
            </button>
          </div>
        </div>
